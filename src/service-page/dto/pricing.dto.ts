...
export class CreateServicePricingDto {
  ...
  @ApiProperty({
    description: 'Currency code for the price (ISO 4217 format).',
    example: 'USD',
  })
  @IsString()
  @MaxLength(3)
  ...
  @ApiProperty({
    description: 'Duration unit for the service pricing.',
    example: 'hour',
  })
...
export class ReturnServicePricingDto {
  ...
  @ApiProperty({
    description: 'Date when this pricing was deleted (soft delete).',
  })
  deletedAt: Date;
}
